...
public class ArrayAlgo {
    ...
    /**
     * remove duplicated numbers from sorted array input array will be modified
     * by the function, such that the leading elements are distinct values in
     * sorted order
     * 
     * @param arr
     *            a sorted array
    ...
    /**
     * remove duplicated numbers from sorted array Variant II - allow up to n
     * duplicates. input array will be modified by the function, such that the
     * leading elements are distinct values in sorted order
     * 
     * e.g. input 1, 2, 2, 3, 3, 3, 3, 5 output 1, 2, 2, 3, 3, 5, (the rest
     * don't care)
     * 
     * @param arr
     *            a sorted array
     * @param nDups
     *            maximum number of duplicated allowed. 1 means no duplicated
     *            are allowed.
    ...
    /**
     * Search a value in a roated sorted array. Assumption: no duplicates
     * 
